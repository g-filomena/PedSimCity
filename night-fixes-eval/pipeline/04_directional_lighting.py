...
# Fotios, Yang & Uttley (2015): pedestrian fixation on other people measured at 10.3 m, with
# 15 m recommended as the observation distance. 12 m was already inside that support; 15 m
# matches the recommended figure exactly (register finding B1, horizon half -- the noisy MIN
# statistic over this window is the other half, fixed separately in NightPars.directionalLuxStatistic).
