...
public class TestTime {
    public static void main(String[] args) {
        ...
        LocalDateTime dt = LocalDateTime.of(1970, 1, 1, 0, 0).plusDays(totalDays).plusHours(hours).plusMinutes(minutes);
        ...
        dt = LocalDateTime.of(1970, 1, 1, 0, 0).plusDays(totalDays).plusHours(hours).plusMinutes(minutes);
