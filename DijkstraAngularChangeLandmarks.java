...
public class DijkstraAngularChangeLandmarks {
	...
	Node originNode, destinationNode, primalDestinationNode;
	ArrayList<Node> visitedNodes;
	ArrayList<Node> unvisitedNodes;
	Node previousJunction = null;
	Node safe;
    ...
    public Path dijkstraPath (Node originNode, Node destinationNode, 
    		Node primalDestinationNode, ArrayList<Node> centroidsToAvoid, Node previousJunction, PedestrianSimulation state)
	{
	...
	private void findMinDistances(Node node) 
	{
	    ...
	    {    
            ...
            double globalLandmarkness = landmarkFunctions.globalLandmarknessDualNode(target, primalDestinationNode, true, state);
