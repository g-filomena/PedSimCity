...
public class nodesLookup {
    ...
    static NodeGraph searchRandomNode(Bag geometriesNodes, PedestrianSimulation state)
    {
    ...
    static NodeGraph searchNodeOutsideDistrict(NodeGraph originNode, double radius,	PedestrianSimulation state)
    {
    ...
    static NodeGraph searchNodeWithin(NodeGraph originNode, GeomVectorField vectorField, List<Float> distances, PedestrianSimulation state)
    {
    ...
    static NodeGraph searchNodeWithin(Geometry geo, GeomVectorField vectorField, double lowL, double uppL, PedestrianSimulation state)
    {	    
    ...
    static NodeGraph searchNodeDistributionWithin(Geometry geo, GeomVectorField vectorField,  
    ...
    NodeGraph searchNodeDistribution(PedestrianSimulation state, HashMap<MasonGeometry, Double> nodesMap)
    {
    	double p = state.random.nextFloat();
    	double cumulative = 0.00;
 	  	MasonGeometry randomNode = null; 	
