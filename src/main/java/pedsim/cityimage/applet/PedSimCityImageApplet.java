...
public class PedSimCityImageApplet extends pedsim.core.applet.PedSimCityApplet
  ...
  private void addCityImageControls() {
    ...
    startButtonParallel.addActionListener(
        event -> {
  ...
  protected void updateCityNameOptions() {
    ...
    String selectedMode =
        simulationModeChoice != null ? simulationModeChoice.getSelectedItem() : "Testing Landmarks";
            ...
            () -> {
              try {
                ...
                LoggerUtil.getLogger()
                    .severe("CityImage simulation failed: " + exception.getMessage());
