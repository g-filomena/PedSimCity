...
/**
 * The `EmpiricalAgentsGroup` class represents a group of empirical agents in the simulation. It
 * encapsulates group-specific parameters and attributes that influence the behaviour of agents
 * within the group. These parameters include probabilities for various route choice properties,
 * such as using elements, minimisation approaches, heuristics, region-based navigation, subgoals,
 * distant landmarks, and other route properties. Additionally, it stores information about natural
 * and severing barriers and the group's share in the population.
 */
public class EmpiricalAgentsGroup {
  ...
  /**
   * Sets the properties of the agent's group based on the provided group name and attributes. This
   * method is responsible for configuring various route choice properties and other parameters for
   * agents belonging to a specific group.
   *
   * @param groupName The name of the agent's group.
   * @param attributes An array of attributes containing group-specific parameters.
   */
