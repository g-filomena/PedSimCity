...
public class PedSimCityEmpiricalApplet extends PedSimCityApplet {
  ...
  private final TextField agentsField =
      new TextField(Integer.toString(EmpiricalPars.defaultNumAgents));
  private final TextField tripsField =
      new TextField(Integer.toString(EmpiricalPars.numberTripsPerAgent));
            ...
            () -> {
              try {
                ...
                LoggerUtil.getLogger()
                    .severe("Empirical simulation failed: " + exception.getMessage());
  ...
  private void applyEmpiricalParameters(boolean runInParallel) {
    ...
    EmpiricalPars.numAgents =
        parsePositiveInt(agentsField.getText(), EmpiricalPars.defaultNumAgents);
    EmpiricalPars.numberTripsPerAgent =
        parsePositiveInt(tripsField.getText(), EmpiricalPars.numberTripsPerAgent);
