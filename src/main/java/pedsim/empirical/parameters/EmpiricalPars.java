 ...
 *
 * Core simulation parameters remain in {@link Pars}; this class only stores empirical-mode
 * parameters that should not live in cityimage.TestPars.
 */
public final class EmpiricalPars {
  ...
  public static void applyDefaults() {
    ...
    // Empirical paper/sample default. Pars.setSimulationParameters() derives numAgents from
