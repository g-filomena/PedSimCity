...
public class Populate {
  ...
  /**
   * Helper to safely parse double attributes from GeoPackage geometries.
   * Handles locale-specific decimal separators (commas vs dots) which can cause failures when 
   * reading census data attributes like 'vulnerability_pct' or 'zone_residence_pct'.
   * 
   * @param geometry The MasonGeometry to extract the attribute from.
   * @param attributeName The name of the attribute.
   * @return The parsed double value, or 0.0 if not found or invalid.
   */
