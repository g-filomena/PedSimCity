...
public final class BarrierPreference {
	...
	public void assign(AgentProperties ap) {
		double naturalMean = rescale(0.0, 1.0, NATURAL_OUTPUT_MAX, NATURAL_OUTPUT_MIN, PopulationPars.naturalBarriers);

		double severingMean = rescale(0.0, 1.0, SEVERING_OUTPUT_MIN, SEVERING_OUTPUT_MAX,
