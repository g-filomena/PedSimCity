...
public class LandmarkNavigation {
	 ...
	 *         otherwise.
	 */
	protected boolean checkCriteria(NodeGraph candidateNode, NodeGraph exitGateway, double searchDistance,
	 ...
	 *         and distance gain.
	 */
	protected double calculateScore(NodeGraph candidateNode, NodeGraph destinationNode, boolean regionBased) {
		...
		double distanceGain = (currentDistance - GraphUtils.nodesDistance(candidateNode, destinationNode))
				/ currentDistance;
		if (regionBased)
