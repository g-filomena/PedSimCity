...
/**
 * The class represents a geographic region in the cognitive map. This class stores information
 * about regions, including their unique identifier, graphs, network data, edges, gateways,
...
public class Region {
  ...
  /** A list of nodes within this region. */
  public List<NodeGraph> nodes = new ArrayList<>();
  ...
  public Set<Integer> barriers = new HashSet<>();
}
