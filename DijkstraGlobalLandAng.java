...
public class DijkstraGlobalLandAng {
	...
	private void findMinDistances(Node node) 
	{
		...
		for (Node target : adjacentNodes) 
	    {
	    	...
	    	if (utilities.nodesDistance(node, destinationNode) < utilities.nodesDistance(target, destinationNode)) continue;
        	...
        	double nodeLandmarkness = globalLandmarkness;
...
//       if (anchors == null) return 1.0;
       ...
       {
//    	   double tmp = 0.0;
    	   double tmp = nd.distantScores.get(distantLandmarks.indexOf(dL));
